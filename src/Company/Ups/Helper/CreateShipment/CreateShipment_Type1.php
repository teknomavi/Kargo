...
class CreateShipment_Type1
{
    ...
    /**
     * @var ShipmentInfo_Type1 $ShipmentInfo
     */
     ...
     * @param ShipmentInfo_Type1 $ShipmentInfo
     ...
     * @param string $SessionID
     *
     * @return \Teknomavi\Kargo\Company\Ups\Helper\CreateShipment\CreateShipment_Type1
     */
