...
class ShipmentListInfo_Type1
{
     ...
     *
     * @return \Teknomavi\Kargo\Company\Ups\Helper\CreateShipment\ShipmentListInfo_Type1
     */
     ...
     * @return \DateTime
     */
    public function getDeliveryStartPeriod()
    {
        if ($this->DeliveryStartPeriod == null) {
            return null;
        } else {
            try {
                return new \DateTime($this->DeliveryStartPeriod);
            } catch (\Exception $e) {
                return false;
            }
        }
    ...
    /**
     * @param \DateTime $DeliveryStartPeriod
     *
     * @return \Teknomavi\Kargo\Company\Ups\Helper\CreateShipment\ShipmentListInfo_Type1
     */
    public function setDeliveryStartPeriod(\DateTime $DeliveryStartPeriod = null)
    {
        if ($DeliveryStartPeriod == null) {
            $this->DeliveryStartPeriod = null;
        } else {
     ...
     * @return \DateTime
     */
    public function getDeliveryFinishPeriod()
    {
        if ($this->DeliveryFinishPeriod == null) {
            return null;
        } else {
            try {
                return new \DateTime($this->DeliveryFinishPeriod);
            } catch (\Exception $e) {
                return false;
            }
        }
    ...
    /**
     * @param \DateTime $DeliveryFinishPeriod
     *
     * @return \Teknomavi\Kargo\Company\Ups\Helper\CreateShipment\ShipmentListInfo_Type1
     */
    public function setDeliveryFinishPeriod(\DateTime $DeliveryFinishPeriod = null)
    {
        if ($DeliveryFinishPeriod == null) {
            $this->DeliveryFinishPeriod = null;
        } else {
    ...
    /**
     * @return ArrayOfDimensionInfo_Type2
     */
    ...
    /**
     * @param ArrayOfDimensionInfo_Type2 $PackageDimensions
     *
     * @return \Teknomavi\Kargo\Company\Ups\Helper\CreateShipment\ShipmentListInfo_Type1
     */
     ...
     */
    public function getReturnShipmentInfo()
    {
        return $this->returnShipmentInfo;
    }

    /**
     * @param ReturnShipment $returnShipmentInfo
     *
     * @return \Teknomavi\Kargo\Company\Ups\Helper\CreateShipment\ShipmentListInfo_Type1
     */
